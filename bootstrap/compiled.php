...
class Application extends Container implements HttpKernelInterface, TerminableInterface, ResponsePreparerInterface
{
    ...
    {
        return 'X:\\{directory}\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation' . '/start.php';
    }
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface, JsonSerializable
{
    ...
    {
        static::registerModelEvent('saveds', $callback);
    }
    ...
    {
        return array_merge(array('creating', 'created', 'updating', 'updated', 'deleting', 'deleted', 'saving', 'saveds', 'restoring', 'restored'), $this->observables);
    }
    ...
    {
        $this->fireModelEvent('saveds', false);
        $this->syncOriginal();
